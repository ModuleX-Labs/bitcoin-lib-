...
```mermaid
flowchart LR
    A[User Behavior] --> B[Propagation Engine] --> C[Consensus Calculation] --> D[On-chain Record]
    A1[Social Media] --> B1[Credit System] --> C1[Mining Algorithm] --> D1[Permanent Storage]
    A2[Propagation Tracking] --> B2[Leaderboard Update] --> C2[Reward Distribution] --> D2[Data Verification]
```
